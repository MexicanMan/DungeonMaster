...
namespace Gateway.Exceptions
{
    public class RegistrationException : Exception
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RegistrationException"/> class with the name of the
        /// parameter that causes this exception.
        /// </summary>
        /// <param name="errorMessage">The error message that explains the reason for this exception.</param>
        public RegistrationException(string errorMessage) : base(errorMessage)
        {
        ...
        public RegistrationException(string errorMessage, Exception innerException) : base(errorMessage, innerException)
        {
