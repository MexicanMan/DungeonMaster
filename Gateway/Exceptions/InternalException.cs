...
namespace Gateway.Exceptions
{
    public class InternalException : Exception
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InternalException"/> class with the name of the
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InternalException"/> class with a specified
